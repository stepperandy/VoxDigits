...
const features = [
  ...
  { icon: Zap,          title: 'Lightning Fast',        description: 'Optimized WireGuard routing ensures minimal speed loss globally.',           color: 'text-amber-400',  bg: 'from-amber-500/10 to-transparent',  border: 'border-amber-500/20' },
