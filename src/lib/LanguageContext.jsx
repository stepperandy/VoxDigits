...
export const translations = {
  en: {
    ...
    testimonialsSubtitle: 'Join users worldwide who trust VoxVPN to protect their privacy every day.',
  ...
  es: {
    ...
    testimonialsSubtitle: 'Únete a usuarios de todo el mundo que confían en VoxVPN para proteger su privacidad cada día.',
  ...
  fr: {
    ...
    testimonialsSubtitle: 'Rejoignez les utilisateurs du monde entier qui font confiance à VoxVPN pour protéger leur vie privée chaque jour.',
  ...
  de: {
    ...
    testimonialsSubtitle: 'Treten Sie Nutzern weltweit bei, die VoxVPN vertrauen, um ihre Privatsphäre täglich zu schützen.',
  ...
  zh: {
    ...
    testimonialsSubtitle: '加入全球各地信任VoxVPN每天保护隐私的用户。',
  ...
  ja: {
    ...
    testimonialsSubtitle: '毎日プライバシーを守るためVoxVPNを信頼する世界中のユーザーに加わりましょう。',
  ...
  ar: {
    ...
    testimonialsSubtitle: 'انضم إلى المستخدمين حول العالم الذين يثقون بـ VoxVPN لحماية خصوصيتهم كل يوم.',
