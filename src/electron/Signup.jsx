    ...
    <div className="min-h-screen bg-[#080c18] flex items-center justify-center px-4" style={gridBg}>
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          />
          <p className="text-slate-500 text-sm">Create your VoxVPN account</p>
        </div>

        {/* Card */}
        <div className="rounded-2xl border border-white/8 bg-[#0d1120] p-6 shadow-2xl shadow-black/50">
          <h2 className="text-white font-black text-xl mb-6">Create account</h2>
          ...
          <p className="text-center text-slate-500 text-sm mt-5">
            ...
            <button onClick={onSwitchToLogin} className="text-cyan-400 hover:text-cyan-300 font-bold transition-colors">
              Sign in
            </button>
          </p>
        </div>
