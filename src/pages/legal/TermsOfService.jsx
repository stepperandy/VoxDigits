      ...
      <div className="pt-36 pb-20 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-slate-400 text-sm leading-relaxed">
          {[
            ...
            { title: '6. Limitation of Liability', content: 'VoxVPN is not liable for indirect, incidental, or consequential damages arising from your use of the service. Our total liability is limited to the amount you paid in the last 12 months.' },
            { title: '7. Contact', content: 'For legal inquiries: legal@voxvpn.net' },
          ].map(({ title, content }) => (
            <div key={title}>
