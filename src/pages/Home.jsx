        ...
        <div className="pb-24">
          ...
          <div className="px-4 pt-6 pb-8 bg-gradient-to-b from-[#0a1020] to-[#080c18]">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              Military-grade encryption, no-logs policy, blazing-fast WireGuard protocol.
            </p>
          ...
          <div className="px-4 pt-6">
            ...
            <div className="space-y-3">
              {[
                ...
                { icon: Zap, title: 'WireGuard Protocol', desc: 'Fastest VPN protocol with minimal speed loss.' },
